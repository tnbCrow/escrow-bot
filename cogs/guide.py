...
class guide(commands.Cog):
    ...
    async def guide_seller(self, ctx):
        ...
        embed.add_field(name="4. Deposit Leap Coin", value="Use the command `/deposit tnbc` to deposit tnbc into your crow bot account.", inline=False)
    ...
    async def guide_buyer(self, ctx):
        ...
        embed.add_field(name="7. Withdraw Leap Coin", value="Use the command `/withdraw tnbc amount: AMOUNT` to withdraw Leap Coin into your wallet.", inline=False)
