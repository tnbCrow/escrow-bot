...
class guide(commands.Cog):
    ...
    async def guide_seller(self, ctx):
        ...
        embed.add_field(name="4. Deposit TNBC", value="Use the command `/deposit tnbc` to deposit tnbc into your crow bot account.", inline=False)
        embed.add_field(name="5. Fund the escrow", value="Use the command `/escrow fund escrow_id: ESCROW_ID` to fund TNBC to the escrow.", inline=False)
        ...
        embed.add_field(name="6. Release the escrow", value="Once you've received payment, use the command `/escrow release escrow_id: ESCROW_ID` to release TNBC into buyer's account.", inline=False)
    ...
    async def guide_buyer(self, ctx):
        ...
        embed.add_field(name="7. Withdraw TNBC", value="Use the command `/withdraw tnbc amount: AMOUNT` to withdraw TNBC into your wallet.", inline=False)
